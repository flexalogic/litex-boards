...
from litex_boards.platforms import rhsresearchllc_litefury
...
class BaseSoC(SoCCore):
    def __init__(self, sys_clk_freq=100e6,
        ...
        with_sata       = False,
        **kwargs):
        platform = rhsresearchllc_litefury.Platform()

        # CRG --------------------------------------------------------------------------------------
        self.crg = CRG(platform, sys_clk_freq)

        # SoCCore ----------------------------------------------------------------------------------
        SoCCore.__init__(self, platform, sys_clk_freq, ident="LiteX SoC on RHSResearchLLC LiteFury", **kwargs)
...
def main():
    ...
    parser = LiteXArgumentParser(platform=rhsresearchllc_litefury.Platform, description="LiteX SoC on RHSResearchLLC LiteFury.")
    ...
    if args.load:
        prog = soc.platform.create_programmer(name="vivado")
